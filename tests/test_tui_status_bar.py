...
class TestStatusBar(unittest.TestCase):
    def test_right_segment_is_right_aligned_and_can_be_bold(self) -> None:
        ...
        bar.draw("left", right="v0.5.3 latest", right_attr=0, force=True)
        ...
        self.assertTrue(any((op.s or "").strip().startswith("v0.5.3") and op.attr == curses.A_REVERSE for op in ops))
